...
s = Dict(
    ...
    "scenario_names"=>["NT2040"],#["NT","DE","GA"]#,"NT2030","NT2040","DE2030","DE2040","GA2030","GA2040"
    ...
    "scenario_years"=>["2040"],#Options: ["2020","2030","2040"]
    ...
    push!(scenario_data["Generation"]["Scenarios"]["NT2040"]["BE00"],["Nuclear",3500.0])
    ...
    FileIO.save(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\YUSO_wNuclear2040.jld2",results)
