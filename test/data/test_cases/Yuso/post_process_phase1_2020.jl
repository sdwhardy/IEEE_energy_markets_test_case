...
results=FileIO.load(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\YUSO_wNuclear2020.jld2")
######################################################
...
#BE WF
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\generation_BE_EI2016_2020.csv", dk_gen_load["FD"][!,1:1])
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\cost_BE_EI2016_2020.csv", dk_price["Orig"][!,1:1])

#BE
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\generation_BE2016_2020.csv", dk_gen_load["FD"][!,2:11])
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\cost_BE2016_2020.csv", dk_price["Orig"][!,2:11])

#UK
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\generation_UK2016_2020.csv", dk_gen_load["FD"][!,12:end-2])
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\cost_UK2016_2020.csv", dk_price["Orig"][!,12:end-2])

#Load
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\Load_BEUK2016_2020.csv", dk_gen_load["FD"][!,end-1:end])
###################################################
...
CSV.write(pwd()*"\\test\\data\\test_cases\\Yuso\\2016\\results\\powerflow_BEUK2016_2020.csv", loads)
